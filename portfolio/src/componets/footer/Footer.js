      ...
      <div className="footer">
       ...
       <div className="footer-item">
        ...
        <div className="footer-items">
          <Link className="nav-link" to="#home" smooth > <span>Home</span></Link>
          <Link className="nav-link" to="#projects" smooth><span>Projects</span></Link>
          <Link className="nav-link" to="#about" smooth><span>About Me</span></Link>
          <Link className="nav-link" to="#contact" smooth><span>Contact Me</span></Link>
        </div>
